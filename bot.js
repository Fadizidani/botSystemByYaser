            ...
            msg.edit(':eight_pointed_black_star:| **Now send The Present **').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  message.guild.channels.find("name" , room).send(' <:817125:612542588028846091> ***Giveaway*** <:817125:612542588028846091> ' , {embed: giveEmbed}).then(m => {
                     let re = m.react('🎉');
                     setTimeout(() => {
  ...
  client.on("message", message => {
    if (message.content === "+inv") {
     const embed = new Discord.RichEmbed()
         ...
         .setThumbnail(message.author.avatarURL)
         .setDescription(`**
        https://discordapp.com/api/oauth2/authorize?client_id=611492756354760714&permissions=0&scope=bot رابط اضافة البوت
       ** `)
